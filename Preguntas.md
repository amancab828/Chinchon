...
2. Relaciones con el ConsoleInput al usar el patron Singleton. Si solo es una referencia, he puesto línea discontinua, si esta como atributo ya si pongo una relación
3. Preguntar del UML
	* Referencias
